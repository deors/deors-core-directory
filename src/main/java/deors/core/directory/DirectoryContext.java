...
/**
 * The Directory (LDAP) library context.<br>
 *
 ...
 * <code>deors.core.directory.configuration.properties</code> properties file).<br>
 *
 * The system property <code>deors.core.directory.configuration</code> can be used to inject
 ...
 * @version 1.0
 */
public final class DirectoryContext extends AbstractContext {

    /**
     * The only class instance.
     */
    private static DirectoryContext contextInstance = new DirectoryContext();

    /**
     * The resource bundle name.
     */
    private static final String BUNDLE_NAME = "deors.core.directory.configuration"; //$NON-NLS-1$
     ...
     */
    public static DirectoryContext getContext() {
